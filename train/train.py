...
time_step = 32 # num time step in lstm 2, short range dependency
n_window = 30 # num of window in lstm 1, long range dependency
batch_size = 32
num_epochs = 10

num_layers_event = 2 # lstm 2
hidden_size_event = dim # lstm 2
num_layers_bg = 2 # lstm 1
hidden_size_bg = N # lstm 1
...
dvg = 'kl' # select from kl, js, norm
            # kl -- kl-divergence
            # js -- js-divergence
            # norm -- l1 norm if ord = 1, l2 norm if ord = 2

diameter = dia # graph diameter
scale = 0.1   # kernel density estimate scale
ord = 2       # norm order
